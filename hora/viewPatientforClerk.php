...
{
	$resapp = mysql_query("SELECT * FROM patientinfo");
}
?>
  <body>
...
?>
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
									  <a class="btn btn-primary" href="reportPatient.php?paid=<?php echo $row1["patid"]; ?>"><i class="icon_book"></i></a>
                                      <a class="btn btn-success" href="editPatient.php?paids=<?php echo $row1["patid"]; ?>"><i class="icon_pencil-edit"></i></a>
                                  </div>
                                 </td>
                              </tr>
							<?php
