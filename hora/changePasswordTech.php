...
if(!$useridErr && !$currentpassErr && !$passwordErr && !$confirmPassErr){
      ...
      while($row = mysql_fetch_array($resultpatientrec))
      {
        ...
        $sql= mysql_query("UPDATE users SET password = '$passwordmd5' WHERE userId = '$_POST[empid]'");
                  ...
                  <div class="col-lg-10">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form_five" method="post" action="changePasswordTech.php">
                    <div class="form-group " style="color:green;">
