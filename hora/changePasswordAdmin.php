...
if(!$useridErr && !$currentpassErr && !$passwordErr && !$confirmPassErr){
		  ...
		  while($row1 = mysql_fetch_array($resultpatientrec))
		  {
			  if(($_POST["empid"]!=$row1['userId'])&&($_POST["prevpassword"]!=$row1["password"]))
			  {  
				//$sql= mysql_query("UPDATE users SET password = '$_POST[password]' WHERE userId = '$_POST[empid]'");
				$confirmation2="Your user id or previous password did not much. Try again!";	
			  }
		  }
		}
}	
//else { echo "Your user id or previous password did not much. Try again!";}
                  ...
                  <div class="col-lg-10">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form_four" method="post" action="changePasswordAdmin.php">
