			...
			if(isset($_SESSION["docid"]))
				{
					$resrec= mysql_query("UPDATE doctor SET 
						doctorname='$_POST[fname] $_POST[mname] $_POST[lname]', quali='$_POST[quali]',specialistin='$_POST[special]',contactno ='$_POST[contact]',emailid='$_POST[email]',biodata='$_POST[description]' WHERE docid = '$_POST[docid]' ");
				}
			else
				{
					$resrec= mysql_query("UPDATE doctor SET 
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="">
									  ...
									  <div class="form-group ">
                                          ...
                                          <div class="col-lg-8">
                                              <input class=" form-control" id="docid" name="docid" type="text" value="<?php echo $doctorid; ?>" readonly />
                                          </div>
                                      </div>
                                      <div class="form-group ">
