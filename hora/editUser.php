			...
			if(isset($_SESSION["id"]))
				{
					$resrec= mysql_query("UPDATE employee SET 
						empname='$_POST[fname] $_POST[mname] $_POST[lname]', designation='$_POST[usertype]', contactno ='$_POST[contact]',emailid='$_POST[email]',address='$_POST[address]' WHERE empid = '$_POST[empid]' ");
				}
			else
				{
					$resrec= mysql_query("UPDATE employee SET 
						empname='$_POST[fname] $_POST[mname] $_POST[lname]', designation='$_POST[usertype]',address'$_POST[address]',contactno ='$_POST[contact]',emailid='$_POST[email]' WHERE empid = '$_POST[empid]' ");
				}
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="">
									  ...
									  <div class="form-group ">
                                          ...
                                          <div class="col-lg-8">
                                              <input class=" form-control" id="empid" name="empid" type="text" value="<?php echo $userid; ?>" readonly />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-8">
                                              <input class=" form-control" id="usertype" name="usertype" type="text" value="<?php echo $usertype; ?>"/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
