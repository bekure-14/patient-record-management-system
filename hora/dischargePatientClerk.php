...
if(isset($_POST["search"]))
{
	...
	$resapp = mysql_query("SELECT * FROM patientinfo where patid='$patientid1' AND status='Treated'");
}
else
{
	$resapp = mysql_query("SELECT * FROM patientinfo where status='Treated'");
}
?>
  <body>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>Discharge Patients</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
...
?>
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
									  <a class="btn btn-danger" href="addToOldPatients.php?paids=<?php echo $row1["patid"]; ?>"><i class="icon_close"></i>  Discharge Patient</a>
                                  </div
                                 </td>
                              </tr>
							<?php
