		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_chat"></i>Show All Lab Request</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
						  ...
						  <div class="form">
								  <table class="table table-striped table-advance table-hover col-lg-6">
									<tbody>
										...
										$resresc = mysql_query("SELECT * FROM labrequest where docid ='$_POST[docid]'");
										while($row = mysql_fetch_array($resresc))
											...
											$resresc = mysql_query("SELECT * FROM labrequest");
										while($row = mysql_fetch_array($resresc))
											{	 
												echo " <tr>";
												echo " <td>$row[patid]";
