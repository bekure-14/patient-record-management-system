		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_chat"></i>Show Lab Request</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              View the laboratory test request from Doctor 
                          </header>
								  ...
								  <table class="table table-striped table-advance table-hover col-lg-6">
									<tbody>
										<tr>
											...
											<th><i class="icon_book"></i> Status</th>
										</tr>
										<?php
										if(isset($_POST['docid'])){
										$resresc = mysql_query("SELECT * FROM labrequest where docid ='$_POST[docid]' AND status ='result not sent'");
										while($row = mysql_fetch_array($resresc))
											...
											$resresc = mysql_query("SELECT * FROM labrequest where status ='result not sent'");
										while($row = mysql_fetch_array($resresc))
											{	 
												echo " <tr>";
												echo " <td>$row[patid]";
