...
<!-- ####################################################################################################### -->
<?php
$dnames=$datad=$doctorid="";
 if(isset($_POST["dtar"])&& isset($_POST["dtar2"])&& isset($_POST["docid"]))
{
...
$datad = $datad2= date("Y-m-d");
    ...
    $resapp = mysql_query("SELECT * FROM treatedPatient WHERE date BETWEEN '$datad' AND '$datad2' AND docid ='$doctorid'");
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-th-list"></i>Report Patient History</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <form class="form-validate form-horizontal" method="post" action="reportPatientsToDoc.php">
