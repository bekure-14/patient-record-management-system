				...
				<div class="col-lg-12">
					...
					<div class="body_img col-md-10">
						...
						<p style ="text-align:justified;">The patient information system provides features and funtionalities for managing
						  ...
						  <p> <h4>Step 1: </h4></p>
						  <p>After login the laboratory technician panel (page) is displayed. At the left side the menu list is displayed to operate with the system. 
						     The lab tech have the power to operate on the patient data which is sent of laboratory test. The first page is the home page for Lab Technician.</p>
							 <p> <h4>Step 2: </h4></p>
						  <p>After test also the laboratory technician will send the result to the doctor.</p>
							  <p> <h4>Step 3: </h4></p>
						  <p>The Lab Technician can also change its password.</p>
