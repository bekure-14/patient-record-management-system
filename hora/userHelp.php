				...
				<div class="col-lg-12">
					...
					<div class="body_img col-md-10">
						...
						<p style ="text-align:justified;">The patient information system provides features and funtionalities for managing
						  ...
						  <p> <h4>Step 1: </h4></p>
						  <p>After login the administrator page is displayed. At the left side the menu list is displayed to operate with the system. 
						     The administrator have all the power to administer the overall operations of the system. The first page is the home page for administrator.</p>
							 <p> <h4>Step 2: </h4></p>
						  <p>The next inthe left side menu is new users registration pages. The administrator is responsible for register new doctors and other users 
						      like clerk and laboratory technician. After registering then the admin will create account for those new users.</p>
							  <p> <h4>Step 3: </h4></p>
						  <p>The next is viewing the register users profile. On each user profile the admin has an edit and delete options on the last column of the users table.
						     Therefore, by clicking on each buttons the admin can manipulate the user profile.</p>
							 <p> <h4>Step 4: </h4></p>
						  <p>Clicking in patient info shows the detail of the patients and their status.</p>
						  <p> <h4>Step 5: </h4></p>
						  <p>The system administrator has also a privilage to add or update or delete laboratory test types. Therefore whenever the admin wants to do something with the 
						      laboratory cases he/she uses lab test types menu.</p>
