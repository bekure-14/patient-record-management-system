				...
				<div class="col-lg-12">
					...
					<div class="body_img col-md-10">
						...
						<p style ="text-align:justified;">The patient information system provides features and funtionalities for managing
						  ...
						  <p> <h4>Step 1: </h4></p>
						  <p>After login the clerk panel (page) is displayed. At the left side the menu list is displayed to operate with the system. 
						     The clerk have the power to operate on the patient data starting from patient registration. The first page is the home page for clerk.</p>
							 <p> <h4>Step 2: </h4></p>
						  <p>The next in the left side menu is new or old patients registration pages. The clerk is responsible for register new patients or old patients. 
						  After registering then the clerk will create appointment with the available doctor.</p>
							  <p> <h4>Step 3: </h4></p>
						  <p>The next is the option for a clerk to create appointment and tell the patient to come on the appointed date and time.</p>
							 <p> <h4>Step 4: </h4></p>
						  <p>Clicking in patient info shows the detail of the patients and their status. It also generates a report based on dates.</p>
						  <p> <h4>Step 5: </h4></p>
						  <p>The clerk has also a privilage to discharge the treated patients. Therefore whenever the patient finishes its treatment the clerk checks and discharge it.</p>
